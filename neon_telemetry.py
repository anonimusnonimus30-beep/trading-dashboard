...
BOTS_REGISTRY = {
    ...
    "IWM":  dict(repo="iwm_sentinel",   account="account1", tier="satellite_new",     asset_type="etf",     max_position_pct=6,  max_notional_usd=3000, stop_loss_pct=-15, risk_symbol="SPY"),
    "USMV": dict(repo="usmv_sentinel",  account="account1", tier="satellite_new",     asset_type="etf",     max_position_pct=6,  max_notional_usd=3000, stop_loss_pct=-30, risk_symbol="SPY"),
